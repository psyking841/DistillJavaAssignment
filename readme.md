...
8. The program is written in Java 8 environment. No external libraries (except JUnit is used for unittesting) are used (also see pom file). This meets requirement 5.
